            ...
            <Navbar.Collapse id="navbar-nav">
              <Nav className="me-auto">
                ...
                <NavDropdown title="Услуги" id="services-dropdown">
                  <NavDropdown.Item>Аренда VPS</NavDropdown.Item>
                  <NavDropdown.Item>Аренда VDS</NavDropdown.Item>
                  <NavDropdown.Item>Аренда VPN</NavDropdown.Item>
                  <NavDropdown.Item>Домены</NavDropdown.Item>
                  <NavDropdown.Item>Cloud-Panel</NavDropdown.Item>
                  <NavDropdown.Item>Абузоустойчивые сервера</NavDropdown.Item>
                </NavDropdown>
                <Nav.Link>Реферальная программа</Nav.Link>
                <NavDropdown title="О нас" id="about-dropdown">
                  <NavDropdown.Item>Правила</NavDropdown.Item>
                  <NavDropdown.Item>Условия</NavDropdown.Item>
                </NavDropdown>
              </Nav>
            </Navbar.Collapse>
          </Container>
