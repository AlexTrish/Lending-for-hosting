        ...
        <Container>
          ...
          <Navbar.Collapse id="navbar-nav">
            <Nav className="me-auto">
              <Nav.Link onClick={() => setCurrentMenu('Main')}>{t('menu.main')}</Nav.Link>
              <NavDropdown title={t("menu.services")} id="services-dropdown">
              ...
              <Nav.Link onClick={() => setCurrentMenu('referal')}>{t("menu.referral")}</Nav.Link>
